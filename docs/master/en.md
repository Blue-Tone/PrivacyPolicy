### About the [APP_NAME] app's privacy policy

This privacy policy explains user information transmitted from [APP_NAME] (hereinafter "this application"), and its handling. When using this application, we assume that you agree to this Privacy Policy. Please confirm and understand the contents of this privacy policy and use this application.
